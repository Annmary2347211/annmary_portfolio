  ...
  return (
    <div className="relative h-screen flex justify-center items-center bg-gradient-to-r from-blue-100 to-purple-200 overflow-hidden">
      ...
      <div className="text-center z-10 relative">
        <h1
          className="text-2xl sm:text-3xl md:text-5xl font-bold text-[#333] leading-snug min-h-[60px] sm:min-h-[80px] overflow-hidden whitespace-nowrap border-r-2 border-transparent animate-text-reveal"
        >
          {displayedText}
        </h1>
